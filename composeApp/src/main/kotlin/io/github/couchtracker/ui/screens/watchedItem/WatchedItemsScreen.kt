...
import io.github.couchtracker.tmdb.LocalTmdbLanguagesContext
    ...
    override fun content() {
        when (val itemId = WatchableExternalId.parse(itemId)) {
            is WatchableExternalId.Movie -> when (itemId.movieId) {
                is TmdbExternalMovieId -> Content(movie = TmdbMovie(itemId.movieId.id, LocalTmdbLanguagesContext.current))
