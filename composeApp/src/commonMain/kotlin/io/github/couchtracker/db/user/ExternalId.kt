...
import io.github.couchtracker.db.user.ExternalId.SealedInterfacesCompanion

/**
 * Base interface for all IDs of external providers that are inside the user's database.
 *
