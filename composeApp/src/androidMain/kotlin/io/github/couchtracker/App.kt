...
import io.github.couchtracker.utils.DEFAULT_ANIMATION_DURATION_MS
...
private val FADE_ANIMATION_SPEC = tween<Float>(DEFAULT_ANIMATION_DURATION_MS)
            ...
            CompositionLocalProvider(LocalNavController provides navController) {
                Surface(color = MaterialTheme.colorScheme.background) {
                    NavHost(
                        ...
                        enterTransition = {
                            val slideSpec = tween<IntOffset>(DEFAULT_ANIMATION_DURATION_MS, easing = LinearOutSlowInEasing)
                        ...
                        popExitTransition = {
                            val slideSpec = tween<IntOffset>(DEFAULT_ANIMATION_DURATION_MS, easing = FastOutLinearInEasing)
